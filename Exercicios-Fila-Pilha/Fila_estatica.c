...
#include <stdlib.h>
 ...
 struct _queue {
    ...
    unsigned int qty, tail, head;
    //Dados que podem ser inteiros (inclusive negativos)
    int data[MAX];
 };
/**
 ...
 */
bool Queue_enqueue(Queue* fila, int valor){
 ...
 * @return bool informando o sucesso da operação
 */
bool Queue_dequeue(Queue* fila, int* pvalor){
